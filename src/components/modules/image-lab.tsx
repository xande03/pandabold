...
const IMAGE_MODELS = [
  ...
  { id: "imagen-4.0-fast-generate-001", name: "Imagen 4 Fast", tier: "Rápido", provider: "google" },
  { id: "imagen-4.0-generate-001", name: "Imagen 4", tier: "Pro", provider: "google" },
  { id: "imagen-4.0-ultra-generate-001", name: "Imagen 4 Ultra", tier: "Premium", provider: "google" },
  { id: "gemini-2.5-flash-image", name: "Nano Banana", tier: "Rápido", provider: "google" },
  { id: "gemini-3-pro-image-preview", name: "Nano Banana Pro", tier: "Pro", provider: "google" },
  { id: "gemini-3.1-flash-image-preview", name: "Nano Banana 2", tier: "Pro", provider: "google" },
